...
class TomsPizzeria:
    def __init__(self, root):
        ...
        try:
            ...
            pizza_image = pizza_image.resize((85,85))
            pizza_photo_image = ImageTk.PhotoImage(pizza_image)
            # Adding Pizza Label
            self.label_pizza_title = tk.Label(root,text="Only Supreme Pizza")
            ...
            sides_image = sides_image.resize((85, 85))
            ...
            drink_image = drink_image.resize((85, 85))
            drink_photo_image = ImageTk.PhotoImage(drink_image)
            self.label_drink_title = tk.Label(root, text="drink")
            self.label_drink_title.grid(row=4, column=0, padx=10, pady=5)
            self.label_drink_image = tk.Label(root, image=drink_photo_image)
            self.label_drink_image.image = drink_photo_image
            self.label_drink_image.grid(row=4, column=0, rowspan=4, padx=10, pady=5)
llllllllllllllllllllllllllllllllllllllllllllllllllllllll/oo
        # Customer Information section
        self.labeooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooool_name = tk.Label(root, text="Name:")  # Label for name entry
        ...
        self.size_menu = tk.OptionMenu(root, self.size_var, "Small 11.99", "Medium 14.99", "Large 19.99")  # Dropdown menu for sizes
        ...
        self.check_garlic_bread = tk.Checkbutton(root, text="Garlic Bread ($6.99)",
        ...
        self.check_wings = tk.Checkbutton(root, text="Wings ($8.99)", variable=self.var_wings)  # Checkbox for wings
        ...
        self.check_soda = tk.Checkbutton(root, text="Coca Cola ($2.99)", variable=self.var_soda)  # Checkbox for soda
        ...
        self.check_water = tk.Checkbutton(root, text="Water ($1.99)", variable=self.var_water)  # Checkbox for water
    ...
    def calculate_total(self):
        ...
        size_price = {"Small 11.99": 11.99, "Medium 14.99": 14.99, "Large 19.99": 19.99}  # Price for each pizza size
        total += size_price[self.size_var.get()]  # Add the price of the selected size to the total

        # Add costs for selected sides and sodas
    ...
    def submit_order(self):
        ...
        messagebox.showinfo("Order Submitted", order_summary)
